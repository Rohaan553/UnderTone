...
'''
    ...
    and creates a mapping from abbreviations to their expansions (saved in the "ite.json" file) as well as a mapping from expansions to their abbreviations (saved in the "eti.json" file)
'''
